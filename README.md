...
|---|---|---|---|
| 01 | [IMDB Movie Review Sentiment Analysis](https://nbviewer.org/github/joyhwp/personal_projects/blob/main/01_NLP_IMDB_Sentiment_Analysis/nlp_imdb_sentiment_analysis.ipynb) | NLP | Text preprocessing, sentiment classification |
